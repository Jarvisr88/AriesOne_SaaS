...
# Create buttons attribute
form_buttons = ButtonsAttribute(buttons)

# Get visible buttons for user
user_permissions = ["can_save", "can_cancel"]
visible_buttons = form_buttons.get_visible_buttons(user_permissions)

# Manipulate buttons
form_buttons.disable_button("save")
form_buttons.hide_button("cancel")
form_buttons.update_button_label("save", "Save Changes")
"""
